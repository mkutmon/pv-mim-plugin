...
//        entityWithFeatureToolbarAction.setEnabled(desktop.getSwingEngine().getEngine().hasVPathway());
    ...
    */
     ...
     */
    public class InTransOption implements PathwayElementMenuHook {
        VPathway vPathway;
       /**
     ...
     */
    public class NewFeatureOption implements PathwayElementMenuHook {
        VPathway vPathway;
        Group group;
       /**
        * This method is called whenever the user right-clicks
       ...
       public void pathwayElementMenuHook(VPathwayElement e, JPopupMenu menu)
       {
        ...
        class ShowAddFeatureAction extends AbstractAction implements SelectionListener {
            private VPathwayElement elt;
